...
*   Two different templates for displaying the books. List view with description OR Grid view with only the covers.
...
= Some of my shelves/books appears intermittently, why is this? =

I am aware of this issue although I cannot yet replicate it. It seems to be a problem with either cURL or the actual API. I am working on a work around.

For best results use max < 40 and only 1 or two shelves per page.
